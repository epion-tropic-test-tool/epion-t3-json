...
/**
 * JSON比較結果一覧(レポート用)を作成する. このクラスのメソッドの大半は、JSONAssertライブラリの中身をもとに作成している.
 * 
 * @author
 */
public class CreateJsonDiffListHelper {
    ...
    public CreateJsonDiffListHelper(Map<String, JsonDiff> assertErrorDiffMap, List<String> ignoreStrList) {
        ...
        if (ignoreStrList != null) {
            for (String ignoreStr : ignoreStrList) {
                ...
                ignorePatternList.add(Pattern.compile(ignoreStr.replace("[", "\\[")
                        .replace("]", "\\]")
                        .replace(".", "\\.")
                        .replace("**\\.", "(?:.+\\\\.)?")
                        .replace("**", ".+")
     ...
     */
    public void compareJSON(String prefix, JSONObject expected, JSONObject actual) throws JSONException {
     ...
     * @throws JSONException
     */
    private void checkJsonObjectKeysActualInExpected(String prefix, JSONObject expected, JSONObject actual)
            throws JSONException {
     ...
     * @throws JSONException
     */
    private void checkJsonObjectKeysExpectedInActual(String prefix, JSONObject expected, JSONObject actual)
            throws JSONException {
     ...
     * 
     * @param prefix JSONパス
     * @param expectedValue 期待値オブジェクト
     * @param actualValue 取得値オブジェクト
     * @throws JSONException エラー
     */
    private void compareValues(String prefix, Object expectedValue, Object actualValue) throws JSONException {
        // クラスが一致しているか
     ...
     * @throws JSONException
     */
    private void compareJSONArray(String prefix, JSONArray expected, JSONArray actual) throws JSONException {
     ...
     * @throws JSONException
     */
    private void compareJSONArrayWithStrictOrder(String key, JSONArray expected, JSONArray actual)
            throws JSONException {
